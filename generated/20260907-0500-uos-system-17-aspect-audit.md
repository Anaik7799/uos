...
|---|---|---|---|---|---|---|---|---|---|
| 1 | Substrate & Hardware Storage Safety | PASS | PASS | FAIL | PASS | PASS | DECLARED | DECLARED | DECLARED |
...
| 4 | Gleam/OTP Root Supervisor | DECLARED | DECLARED | DECLARED | FAIL | DECLARED | DECLARED | PASS | DECLARED |
...
| 7 | Mathematical Authority & Conservation | DECLARED | DECLARED | FAIL | DECLARED | PASS | DECLARED | DECLARED | PASS |
...
| 15 | Comprehensive Verification Checklist | FAIL | FAIL | PASS | PASS | DECLARED | DECLARED | DECLARED | DECLARED |
| 16 | Knowledge Management Triad | PASS | PASS | PASS | DECLARED | DECLARED | PASS | DECLARED | DECLARED |
| 17 | Sa-Plan & Bionic Durable Workflows | DECLARED | DECLARED | FAIL | PASS | PASS | DECLARED | PASS | DECLARED |

Totals: PASS 53 · DECLARED 77 · FAIL 6 · admissible=false · no_failures=false
