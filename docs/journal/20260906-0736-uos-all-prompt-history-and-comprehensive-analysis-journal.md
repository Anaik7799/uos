...
```mermaid
flowchart TD
    subgraph SVR["UOS Unified Verification Substrate"]
        MVR["Master Verification Registry & Supervisor\n(uos_sup.gleam)"]
        WCE["Web Check Engine\n(5 Surfaces)"]
        BEB["Browser Emulation Bridge\n(64 Suites)"]
        ODO["OCaml Differential Oracle\n(432 Files)"]
        DMC["Rocha Cut & Hardware Interlock\n(Delta T_13 = 0, Lock 25503L801736)"]
        COCKPIT["Tailscale Live Web Cockpit\n(/verify-patrol on Port 4100)"]
