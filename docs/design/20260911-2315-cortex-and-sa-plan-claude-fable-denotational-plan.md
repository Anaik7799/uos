...
**Plan Identifier**: `docs/design/20260911-2315-cortex-and-sa-plan-claude-fable-denotational-plan.md`  
...
**Tailscale FQDN Link**: [http://nas-1.tail55d152.ts.net:8100/docs/design/20260911-2315-cortex-and-sa-plan-claude-fable-denotational-plan.md](http://nas-1.tail55d152.ts.net:8100/docs/design/20260911-2315-cortex-and-sa-plan-claude-fable-denotational-plan.md)  
**Timestamp Mandate**: `20260911-2315-` (`contracts/rules/timestamp-mandate.md`)  
**Zero-Muda Purity**: 0 Bevy, 0 Graphite, 0 foreign C shared libs (`SC-MUDA-001`)  
**Hardware Storage Interlock**: `HARD_DENIED_SYSTEM_OS_SERIAL = "25503L801736"` strictly locked  
...
8. **Sovereign Execution under Claude Fable (`L0-fable`)**: Task claiming, 1-hour lease enforcement, and cryptographic attestation ledgered in Jujutsu commit history.
...
## 8. Proposed Changes (Component Grouping)
...
- Implements `CortexIntent`, `CortexActionResult`, `CortexStatus` records.
