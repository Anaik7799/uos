# c3i-target — c3i.target

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-target.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-target.md)
...
| address | `uos/holon/L4/runtime/c3i-target` |
| uid | `f1caa26755ff8` |
| whole | [ops](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ops.md) — UOS operational units |
| parts | — (leaf) |
| module | `~/.config/systemd/user/c3i.target (installed; authoritative def not found as a tracked file in /home/an/dev/ver/c3i, host-local unit)` |
| domain | sync |
