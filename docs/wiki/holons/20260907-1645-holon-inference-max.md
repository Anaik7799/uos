# inference-max — Modular MAX inference tier

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-inference-max.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-inference-max.md)
...
|---|---|
| id | `inference-max` |
| name | Modular MAX inference tier |
| Sanskrit | anumana-yantra (अनुमान-यन्त्र) |
| kind | subsystem |
| level | L2 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L2/intelligence/inference-max` |
| uid | `ac54a3fa9bc2f` |
...
| parts | [c3i-sa-plan-inference-service](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-sa-plan-inference-service.md), [max-kernel-mojo](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-max-kernel-mojo.md) |
| module | `services/inference/max` |
| lifecycle | dormant |
