# iam-supervisor-gleam — iam/supervisor.gleam

#fractal-l0 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-iam-supervisor-gleam.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-iam-supervisor-gleam.md)
...
| field | value |
|---|---|
| id | `iam-supervisor-gleam` |
| name | iam/supervisor.gleam |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L0 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L0/runtime/iam-supervisor-gleam` |
| uid | `feb4edea99f14` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/iam/supervisor.gleam` |
| domain | iam |
