# spec-child-zigvm-port-manager — spec-child: zigvm_port_manager

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-spec-child-zigvm-port-manager.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-zigvm-port-manager.md)
...
| field | value |
|---|---|
| id | `spec-child-zigvm-port-manager` |
| name | spec-child: zigvm_port_manager |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/spec-child-zigvm-port-manager` |
| uid | `5c73f473c70c1` |
| whole | [zigvm](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-zigvm.md) — ZigVM deterministic runtime |
| parts | — (leaf) |
