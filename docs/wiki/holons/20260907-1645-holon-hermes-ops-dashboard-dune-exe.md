# hermes-ops-dashboard-dune-exe — hermes_ops_dashboard (dune exe)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-hermes-ops-dashboard-dune-exe.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-hermes-ops-dashboard-dune-exe.md)
...
| field | value |
|---|---|
| id | `hermes-ops-dashboard-dune-exe` |
| name | hermes_ops_dashboard (dune exe) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/hermes-ops-dashboard-dune-exe` |
| uid | `494688f65853f` |
...
| parts | — (leaf) |
| module | `engines/hermes/modules/hermes_ops_dashboard/dune` |
| domain | cog |
