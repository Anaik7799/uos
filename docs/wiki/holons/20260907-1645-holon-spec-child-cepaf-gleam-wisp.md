# spec-child-cepaf-gleam-wisp — spec-child: cepaf_gleam_wisp

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-spec-child-cepaf-gleam-wisp.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-cepaf-gleam-wisp.md)
...
| field | value |
|---|---|
| id | `spec-child-cepaf-gleam-wisp` |
| name | spec-child: cepaf_gleam_wisp |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/spec-child-cepaf-gleam-wisp` |
| uid | `35c76f02a3012` |
