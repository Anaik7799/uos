# unified-verification-supervisor-gleam — unified_verification_supervisor.gleam

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-unified-verification-supervisor-gleam.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-unified-verification-supervisor-gleam.md)
...
| field | value |
|---|---|
| id | `unified-verification-supervisor-gleam` |
| name | unified_verification_supervisor.gleam |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/unified-verification-supervisor-gleam` |
| uid | `416189e3a1735` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/verification/unified_verification_supervisor.gleam` |
