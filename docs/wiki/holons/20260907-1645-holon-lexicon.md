# lexicon — Sanskrit/English lexicon

#fractal-l3 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-lexicon.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-lexicon.md)
...
|---|---|
| id | `lexicon` |
| name | Sanskrit/English lexicon |
| Sanskrit | kośa (कोश) |
| kind | component |
| level | L3 |
| plane | language · bhāṣā (भाषा) |
| address | `uos/holon/L3/language/lexicon` |
| uid | `239aec50c94b6` |
| whole | [acl](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-acl.md) — Agent communication language |
| parts | — (leaf) |
| module | `uos_tui/acl (lexicon)` |
| lifecycle | dormant |
