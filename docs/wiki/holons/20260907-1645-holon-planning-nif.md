# planning-nif — planning_nif

#fractal-l1 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-planning-nif.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-planning-nif.md)
...
| address | `uos/holon/L1/runtime/planning-nif` |
| uid | `16785536f7f61` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/planning_nif.erl -> priv/native/planning_nif.so` |
| process_class | nif |
