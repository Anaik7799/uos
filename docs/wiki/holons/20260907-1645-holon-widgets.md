# widgets — Widget catalog (17 families)

#fractal-l3 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-widgets.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-widgets.md)
...
|---|---|
| id | `widgets` |
| name | Widget catalog (17 families) |
| Sanskrit | aṅga (अङ्ग) |
| kind | component |
| level | L3 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L3/runtime/widgets` |
| uid | `08c07051187ca` |
| whole | [app](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-app.md) — TEA application core |
| parts | — (leaf) |
| module | `uos_tui/widget` |
| lifecycle | dormant |
