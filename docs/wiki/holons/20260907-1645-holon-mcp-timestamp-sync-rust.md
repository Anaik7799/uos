# mcp-timestamp-sync-rust — mcp/timestamp_sync (Rust)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-mcp-timestamp-sync-rust.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-mcp-timestamp-sync-rust.md)
...
| field | value |
|---|---|
| id | `mcp-timestamp-sync-rust` |
| name | mcp/timestamp_sync (Rust) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/mcp-timestamp-sync-rust` |
| uid | `be6ecdd4f8efc` |
...
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/sub-projects/c3i/mcp/timestamp_sync` |
| domain | cog |
