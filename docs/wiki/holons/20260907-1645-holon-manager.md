# manager — F´ managing agent

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-manager.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-manager.md)
...
|---|---|
| id | `manager` |
| name | F´ managing agent |
| Sanskrit | prabandhaka (प्रबन्धक) |
| kind | component |
| level | L2 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L2/intelligence/manager` |
| uid | `6ee4a469cd4e9` |
...
| parts | [ooda](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ooda.md) |
