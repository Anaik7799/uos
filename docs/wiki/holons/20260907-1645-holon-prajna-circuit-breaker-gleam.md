# prajna-circuit-breaker-gleam — prajna/circuit_breaker.gleam

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-prajna-circuit-breaker-gleam.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-prajna-circuit-breaker-gleam.md)
...
| field | value |
|---|---|
| id | `prajna-circuit-breaker-gleam` |
| name | prajna/circuit_breaker.gleam |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/prajna-circuit-breaker-gleam` |
| uid | `91d31462d3d1a` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/prajna/circuit_breaker.gleam` |
