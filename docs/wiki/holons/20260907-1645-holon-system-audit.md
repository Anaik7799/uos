# system-audit — System-wide audit

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-system-audit.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-system-audit.md)
...
| Sanskrit | sarva-parīkṣā (सर्व-परीक्षा) |
| kind | component |
| level | L2 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L2/intelligence/system-audit` |
| uid | `38f84791f42bb` |
