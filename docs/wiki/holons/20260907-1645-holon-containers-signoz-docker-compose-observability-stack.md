# containers-signoz-docker-compose-observability-stack — containers/signoz docker-compose (observability stack)

#fractal-l6 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-containers-signoz-docker-compose-observability-stack.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-containers-signoz-docker-compose-observability-stack.md)
...
| field | value |
|---|---|
| id | `containers-signoz-docker-compose-observability-stack` |
| name | containers/signoz docker-compose (observability stack) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L6 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L6/runtime/containers-signoz-docker-compose-observability-stack` |
| uid | `d7fb1fe609d6e` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/containers/signoz/docker-compose.yml` |
