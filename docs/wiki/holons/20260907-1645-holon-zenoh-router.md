# zenoh-router — Zenoh router c3i-zenoh-router-1

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-zenoh-router.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-zenoh-router.md)
...
|---|---|
| id | `zenoh-router` |
| name | Zenoh router c3i-zenoh-router-1 |
| Sanskrit | mārga-darśaka (मार्ग-दर्शक) |
| kind | component |
| level | L2 |
| plane | messaging · sandeśa (सन्देश) |
| address | `uos/holon/L2/messaging/zenoh-router` |
| uid | `b381d038452ef` |
