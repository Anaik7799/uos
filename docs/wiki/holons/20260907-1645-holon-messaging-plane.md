# messaging-plane — Messaging plane

#fractal-l1 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-messaging-plane.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-messaging-plane.md)
...
| Sanskrit | sandeśa-tala (सन्देश-तल) |
| kind | plane |
| level | L1 |
| plane | messaging · sandeśa (सन्देश) |
| address | `uos/holon/L1/messaging/messaging-plane` |
| uid | `a68cf2b68e654` |
| whole | [planes](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-planes.md) — Seven planes |
| parts | [board](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-board.md), [zenoh-router](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-zenoh-router.md), [uos-swarm](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-uos-swarm.md) |
| module | `uos_tui/board` |
| lifecycle | dormant |
