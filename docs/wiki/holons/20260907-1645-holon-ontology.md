# ontology — Fractal Textual ontology

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-ontology.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ontology.md)
...
|---|---|
| id | `ontology` |
| name | Fractal Textual ontology |
| Sanskrit | sattā-śāstra (सत्ता-शास्त्र) |
| kind | component |
| level | L2 |
| plane | structure · saṃracanā (संरचना) |
| address | `uos/holon/L2/structure/ontology` |
| uid | `c205f711aa5d8` |
| whole | [structure-plane](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-structure-plane.md) — Structure plane |
| parts | — (leaf) |
