# vault-supervisor-gleam — vault_supervisor.gleam

#fractal-l0 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-vault-supervisor-gleam.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-vault-supervisor-gleam.md)
...
| field | value |
|---|---|
| id | `vault-supervisor-gleam` |
| name | vault_supervisor.gleam |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L0 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L0/runtime/vault-supervisor-gleam` |
| uid | `1fda1fd0d4f40` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/vault_supervisor.gleam` |
| domain | secret |
