# uos-clock-guard-service — uos-clock-guard@.service

#fractal-l0 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-uos-clock-guard-service.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-uos-clock-guard-service.md)
...
| field | value |
|---|---|
| id | `uos-clock-guard-service` |
| name | uos-clock-guard@.service |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L0 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L0/runtime/uos-clock-guard-service` |
| uid | `3212278701155` |
...
| parts | — (leaf) |
| module | `~/.config/systemd/user/uos-clock-guard@.service; UOS copy at ops/observability/20260907-0941-uos-clock-guard@.service` |
| domain | sync |
