# spec-child-planning-worker — spec-child: planning_worker

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-spec-child-planning-worker.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-planning-worker.md)
...
| field | value |
|---|---|
| id | `spec-child-planning-worker` |
| name | spec-child: planning_worker |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/spec-child-planning-worker` |
| uid | `ee934e9f5eeb0` |
