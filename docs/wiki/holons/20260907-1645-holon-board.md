...
[docs/wiki/holons/20260907-1645-holon-board.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-board.md)
...
| id | `board` |
| name | Message board |
| Sanskrit | sandeśa-phalaka (सन्देश-फलक) |
| kind | component |
| level | L2 |
| plane | messaging · sandeśa (सन्देश) |
| address | `uos/holon/L2/messaging/board` |
| uid | `859169b381857` |
