# hermes-vision-dune-exe — hermes_vision (dune exe)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-hermes-vision-dune-exe.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-hermes-vision-dune-exe.md)
...
| field | value |
|---|---|
| id | `hermes-vision-dune-exe` |
| name | hermes_vision (dune exe) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/hermes-vision-dune-exe` |
| uid | `808c4df7996e0` |
...
| parts | — (leaf) |
| module | `engines/hermes/modules/hermes_vision/dune` |
| domain | cog |
