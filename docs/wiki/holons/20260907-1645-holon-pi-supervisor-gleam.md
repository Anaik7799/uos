# pi-supervisor-gleam — pi_supervisor.gleam

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-pi-supervisor-gleam.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-pi-supervisor-gleam.md)
...
| field | value |
|---|---|
| id | `pi-supervisor-gleam` |
| name | pi_supervisor.gleam |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/pi-supervisor-gleam` |
| uid | `4d208d83695d2` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/bridge/pi_supervisor.gleam` |
