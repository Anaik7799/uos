# stpa — STPA & FMEA safety

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-stpa.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-stpa.md)
...
|---|---|
| id | `stpa` |
| name | STPA & FMEA safety |
| Sanskrit | surakṣā (सुरक्षा) |
| kind | component |
| level | L2 |
| plane | control · niyantraṇa (नियन्त्रण) |
| address | `uos/holon/L2/control/stpa` |
| uid | `8bf5c93ae0fc9` |
