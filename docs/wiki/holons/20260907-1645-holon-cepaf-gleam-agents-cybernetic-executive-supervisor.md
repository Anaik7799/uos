# cepaf-gleam-agents-cybernetic-executive-supervisor — cepaf_gleam/agents/cybernetic executive supervisor

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-cepaf-gleam-agents-cybernetic-executive-supervisor.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-cepaf-gleam-agents-cybernetic-executive-supervisor.md)
...
| field | value |
|---|---|
| id | `cepaf-gleam-agents-cybernetic-executive-supervisor` |
| name | cepaf_gleam/agents/cybernetic executive supervisor |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/cepaf-gleam-agents-cybernetic-executive-supervisor` |
| uid | `36000bc24e81e` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/agents/cybernetic.gleam` |
| process_class | otp-child |
| status | integrated |
| lifecycle | dormant |
