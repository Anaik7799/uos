# ha-lyapunov-proof-gleam — ha/lyapunov_proof.gleam

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-ha-lyapunov-proof-gleam.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ha-lyapunov-proof-gleam.md)
...
| field | value |
|---|---|
| id | `ha-lyapunov-proof-gleam` |
| name | ha/lyapunov_proof.gleam |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/ha-lyapunov-proof-gleam` |
| uid | `2e254375b9996` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/ha/lyapunov_proof.gleam` |
