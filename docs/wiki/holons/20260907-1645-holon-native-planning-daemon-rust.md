# native-planning-daemon-rust — native/planning_daemon (Rust)

#fractal-l1 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-native-planning-daemon-rust.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-native-planning-daemon-rust.md)
...
| field | value |
|---|---|
| id | `native-planning-daemon-rust` |
| name | native/planning_daemon (Rust) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L1 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L1/runtime/native-planning-daemon-rust` |
| uid | `e57060f886714` |
...
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/sub-projects/c3i/native/planning_daemon` |
