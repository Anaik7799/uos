# hermes-sysml-dune-exe — hermes_sysml (dune exe)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-hermes-sysml-dune-exe.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-hermes-sysml-dune-exe.md)
...
| field | value |
|---|---|
| id | `hermes-sysml-dune-exe` |
| name | hermes_sysml (dune exe) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/hermes-sysml-dune-exe` |
| uid | `c9e2a8b152b07` |
...
| parts | — (leaf) |
| module | `engines/hermes/modules/hermes_sysml/dune` |
| domain | cog |
