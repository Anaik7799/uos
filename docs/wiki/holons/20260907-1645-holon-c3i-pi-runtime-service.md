# c3i-pi-runtime-service — c3i-pi-runtime.service

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-pi-runtime-service.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-pi-runtime-service.md)
...
| field | value |
|---|---|
| id | `c3i-pi-runtime-service` |
| name | c3i-pi-runtime.service |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/c3i-pi-runtime-service` |
| uid | `aa0c40a70db93` |
...
| parts | — (leaf) |
| module | `node packages/coding-agent/dist/cli.js --provider google --mode rpc (Pi-mono)` |
