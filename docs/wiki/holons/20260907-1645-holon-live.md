# live — OTP live driver

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-live.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-live.md)
...
|---|---|
| id | `live` |
| name | OTP live driver |
| Sanskrit | jīva-cālaka (जीव-चालक) |
| kind | component |
| level | L2 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L2/runtime/live` |
| uid | `247610f4dedd4` |
