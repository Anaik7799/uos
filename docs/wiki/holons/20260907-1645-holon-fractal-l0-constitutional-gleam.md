# fractal-l0-constitutional-gleam — fractal/l0_constitutional.gleam

#fractal-l0 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-fractal-l0-constitutional-gleam.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-fractal-l0-constitutional-gleam.md)
...
| field | value |
|---|---|
| id | `fractal-l0-constitutional-gleam` |
| name | fractal/l0_constitutional.gleam |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L0 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L0/runtime/fractal-l0-constitutional-gleam` |
| uid | `2ac26788c808f` |
