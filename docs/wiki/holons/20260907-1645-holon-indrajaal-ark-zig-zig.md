# indrajaal-ark-zig-zig — indrajaal_ark_zig (Zig)

#fractal-l1 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-indrajaal-ark-zig-zig.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-indrajaal-ark-zig-zig.md)
...
| field | value |
|---|---|
| id | `indrajaal-ark-zig-zig` |
| name | indrajaal_ark_zig (Zig) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L1 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L1/runtime/indrajaal-ark-zig-zig` |
| uid | `6b7adb3ec11b7` |
...
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/sub-projects/c3i/lib/indrajaal_ark_zig/src/main.zig` |
