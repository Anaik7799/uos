# spec-child-mcp-unified-gateway — spec-child: mcp_unified_gateway

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-spec-child-mcp-unified-gateway.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-mcp-unified-gateway.md)
...
| field | value |
|---|---|
| id | `spec-child-mcp-unified-gateway` |
| name | spec-child: mcp_unified_gateway |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L5/runtime/spec-child-mcp-unified-gateway` |
| uid | `00168322b4774` |
