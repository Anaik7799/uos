# c3i-ocaml-nif — c3i_ocaml_nif

#fractal-l1 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-ocaml-nif.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-ocaml-nif.md)
...
| address | `uos/holon/L1/runtime/c3i-ocaml-nif` |
| uid | `7983c14a28f27` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/c3i_ocaml_nif.erl -> priv/c3i_ocaml_nif.so` |
| process_class | nif |
| status | integrated |
| lifecycle | dormant |
