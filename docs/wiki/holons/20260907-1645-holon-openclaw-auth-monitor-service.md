# openclaw-auth-monitor-service — openclaw-auth-monitor.service

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-openclaw-auth-monitor-service.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-openclaw-auth-monitor-service.md)
...
| field | value |
|---|---|
| id | `openclaw-auth-monitor-service` |
| name | openclaw-auth-monitor.service |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/openclaw-auth-monitor-service` |
| uid | `30c48ee2fa133` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/sub-projects/openclaw/scripts/systemd/openclaw-auth-monitor.service` |
