# c3i-iam-native-guard-service — c3i-iam-native-guard.service

#fractal-l0 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-iam-native-guard-service.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-iam-native-guard-service.md)
...
| field | value |
|---|---|
| id | `c3i-iam-native-guard-service` |
| name | c3i-iam-native-guard.service |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L0 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L0/runtime/c3i-iam-native-guard-service` |
| uid | `fd4aba6759e3b` |
...
| parts | — (leaf) |
| module | `/home/an/NAS-setup/c3i/scripts/systemd/c3i-user/iam-native-guard.sh` |
| domain | iam |
| process_class | systemd |
