# ag-ui-sse-stream-ag-ui-events — AG-UI SSE stream /ag-ui/events

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-ag-ui-sse-stream-ag-ui-events.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ag-ui-sse-stream-ag-ui-events.md)
...
| field | value |
|---|---|
| id | `ag-ui-sse-stream-ag-ui-events` |
| name | AG-UI SSE stream /ag-ui/events |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | messaging · sandeśa (सन्देश) |
| address | `uos/holon/L4/messaging/ag-ui-sse-stream-ag-ui-events` |
| uid | `3e1a40f36b37f` |
...
| parts | — (leaf) |
| module | `apps/indrajaal_gleam_web/src/indrajaal_gleam_web.gleam router ('ag-ui' path branch calling cepaf_gleam/ui/wisp/router as c3i_router)` |
