# native-ignition-daemon-rust — native/ignition_daemon (Rust)

#fractal-l1 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-native-ignition-daemon-rust.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-native-ignition-daemon-rust.md)
...
| field | value |
|---|---|
| id | `native-ignition-daemon-rust` |
| name | native/ignition_daemon (Rust) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L1 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L1/runtime/native-ignition-daemon-rust` |
| uid | `d30ce185e1bda` |
...
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/sub-projects/c3i/native/ignition_daemon` |
