# headless — Headless pilot

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-headless.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-headless.md)
...
| id | `headless` |
| name | Headless pilot |
| Sanskrit | parīkṣaka (परीक्षक) |
| kind | component |
| level | L2 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L2/runtime/headless` |
| uid | `e893d4b343551` |
