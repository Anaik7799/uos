# graphene-nif-rust-crate-lib-cepaf-gleam-native-graphene-nif — graphene_nif Rust crate (lib/cepaf_gleam/native/graphene_nif)

#fractal-l1 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-graphene-nif-rust-crate-lib-cepaf-gleam-native-graphene-nif.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-graphene-nif-rust-crate-lib-cepaf-gleam-native-graphene-nif.md)
...
| field | value |
|---|---|
| id | `graphene-nif-rust-crate-lib-cepaf-gleam-native-graphene-nif` |
| name | graphene_nif Rust crate (lib/cepaf_gleam/native/graphene_nif) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L1 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L1/runtime/graphene-nif-rust-crate-lib-cepaf-gleam-native-graphene-nif` |
| uid | `5fdc3bb417e00` |
| whole | [native-nifs](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-native-nifs.md) — Native bounded NIF kernels |
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/lib/cepaf_gleam/native/graphene_nif (Cargo [[bin]]/cdylib wrapping graphene/tiny-skia/kurbo/resvg/plotters/vega-lite/petgraph crates)` |
