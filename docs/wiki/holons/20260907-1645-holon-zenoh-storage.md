# zenoh-storage — Zenoh memory storages

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-zenoh-storage.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-zenoh-storage.md)
...
|---|---|
| id | `zenoh-storage` |
| name | Zenoh memory storages |
| Sanskrit | megha-smṛti (मेघ-स्मृति) |
| kind | component |
| level | L2 |
| plane | data plane · dattāṃśa (दत्तांश) |
| address | `uos/holon/L2/data/zenoh-storage` |
| uid | `6ac16e36287cf` |
| whole | [data-plane](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-data-plane.md) — Data plane |
| parts | — (leaf) |
| module | `ops/zenoh (storage_manager)` |
| lifecycle | dormant |
