# ferriskey-vendored-operator-rust — ferriskey-vendored/operator (Rust)

#fractal-l0 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-ferriskey-vendored-operator-rust.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ferriskey-vendored-operator-rust.md)
...
| field | value |
|---|---|
| id | `ferriskey-vendored-operator-rust` |
| name | ferriskey-vendored/operator (Rust) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L0 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L0/runtime/ferriskey-vendored-operator-rust` |
| uid | `1b99916fdd709` |
...
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/sub-projects/ferriskey-vendored/operator (Cargo [[bin]])` |
| domain | iam |
