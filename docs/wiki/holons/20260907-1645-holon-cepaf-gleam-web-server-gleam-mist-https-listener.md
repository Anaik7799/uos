# cepaf-gleam-web-server-gleam-mist-https-listener — cepaf_gleam web/server.gleam Mist HTTPS listener

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-cepaf-gleam-web-server-gleam-mist-https-listener.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-cepaf-gleam-web-server-gleam-mist-https-listener.md)
...
| field | value |
|---|---|
| id | `cepaf-gleam-web-server-gleam-mist-https-listener` |
| name | cepaf_gleam web/server.gleam Mist HTTPS listener |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | messaging · sandeśa (सन्देश) |
| address | `uos/holon/L4/messaging/cepaf-gleam-web-server-gleam-mist-https-listener` |
| uid | `de246e32d2d33` |
| whole | [cepaf-gleam](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-cepaf-gleam.md) — CEPAF Gleam control plane |
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/web/server.gleam:1243-1245` |
