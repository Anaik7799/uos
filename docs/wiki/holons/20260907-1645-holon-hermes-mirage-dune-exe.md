# hermes-mirage-dune-exe — hermes_mirage (dune exe)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-hermes-mirage-dune-exe.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-hermes-mirage-dune-exe.md)
...
| field | value |
|---|---|
| id | `hermes-mirage-dune-exe` |
| name | hermes_mirage (dune exe) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/hermes-mirage-dune-exe` |
| uid | `282a0716b5dba` |
...
| parts | — (leaf) |
| module | `engines/hermes/modules/hermes_mirage/dune` |
| domain | cog |
