...
[docs/wiki/holons/20260907-1645-holon-data-plane.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-data-plane.md)
...
| id | `data-plane` |
| name | Data plane |
| Sanskrit | dattāṃśa-tala (दत्तांश-तल) |
| kind | plane |
| level | L1 |
| plane | data plane · dattāṃśa (दत्तांश) |
| address | `uos/holon/L1/data/data-plane` |
| uid | `8371f83da5ff2` |
| whole | [planes](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-planes.md) — Seven planes |
| parts | [ledger](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ledger.md), [ets](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ets.md), [zenoh-storage](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-zenoh-storage.md) |
| module | `uos_tui/board (ledger)` |
| lifecycle | dormant |
