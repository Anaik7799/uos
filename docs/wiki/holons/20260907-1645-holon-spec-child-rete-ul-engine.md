# spec-child-rete-ul-engine — spec-child: rete_ul_engine

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-spec-child-rete-ul-engine.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-rete-ul-engine.md)
...
| field | value |
|---|---|
| id | `spec-child-rete-ul-engine` |
| name | spec-child: rete_ul_engine |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L5/runtime/spec-child-rete-ul-engine` |
| uid | `f28e50ceab74c` |
