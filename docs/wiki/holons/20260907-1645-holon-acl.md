...
[docs/wiki/holons/20260907-1645-holon-acl.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-acl.md)
...
|---|---|
| id | `acl` |
| name | Agent communication language |
| Sanskrit | sambhāṣā (सम्भाषा) |
| kind | component |
| level | L2 |
| plane | language · bhāṣā (भाषा) |
| address | `uos/holon/L2/language/acl` |
| uid | `2344f08e51026` |
| whole | [language-plane](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-language-plane.md) — Language plane |
| parts | [lexicon](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-lexicon.md) |
| module | `uos_tui/acl` |
| lifecycle | dormant |
