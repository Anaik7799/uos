# ha-freshness-monitor-gleam — ha/freshness_monitor.gleam

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-ha-freshness-monitor-gleam.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ha-freshness-monitor-gleam.md)
...
| field | value |
|---|---|
| id | `ha-freshness-monitor-gleam` |
| name | ha/freshness_monitor.gleam |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/ha-freshness-monitor-gleam` |
| uid | `6c207036ee4b3` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/ha/freshness_monitor.gleam` |
| domain | sync |
