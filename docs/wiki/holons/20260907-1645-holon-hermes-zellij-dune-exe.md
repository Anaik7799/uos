# hermes-zellij-dune-exe — hermes_zellij (dune exe)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-hermes-zellij-dune-exe.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-hermes-zellij-dune-exe.md)
...
| field | value |
|---|---|
| id | `hermes-zellij-dune-exe` |
| name | hermes_zellij (dune exe) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/hermes-zellij-dune-exe` |
| uid | `4463d41eab90e` |
...
| parts | — (leaf) |
| module | `engines/hermes/modules/hermes_zellij/dune` |
| domain | cog |
