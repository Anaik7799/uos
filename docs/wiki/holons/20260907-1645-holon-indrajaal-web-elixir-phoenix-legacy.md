# indrajaal-web-elixir-phoenix-legacy — indrajaal_web (Elixir/Phoenix, legacy)

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-indrajaal-web-elixir-phoenix-legacy.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-indrajaal-web-elixir-phoenix-legacy.md)
...
| field | value |
|---|---|
| id | `indrajaal-web-elixir-phoenix-legacy` |
| name | indrajaal_web (Elixir/Phoenix, legacy) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/indrajaal-web-elixir-phoenix-legacy` |
| uid | `c143e39082725` |
| whole | [indrajaal-gleam-web](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-indrajaal-gleam-web.md) — Indrajaal Gleam web |
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/sub-projects/c3i/lib/indrajaal_web/{endpoint,router,presence,telemetry,guardian,gettext,rate_limiter,connection_tracker,open_api,unified_controller_patterns}.ex` |
| domain | unassigned |
