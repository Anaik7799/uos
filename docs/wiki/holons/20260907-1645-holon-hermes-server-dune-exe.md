# hermes-server-dune-exe — hermes_server (dune exe)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-hermes-server-dune-exe.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-hermes-server-dune-exe.md)
...
| field | value |
|---|---|
| id | `hermes-server-dune-exe` |
| name | hermes_server (dune exe) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/hermes-server-dune-exe` |
| uid | `867c3d4272b2d` |
...
| parts | — (leaf) |
| module | `engines/hermes/modules/hermes_server/dune` |
| domain | cog |
