# sa-plan-tls-service-deploy-packaging — sa-plan-tls.service (deploy packaging)

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-sa-plan-tls-service-deploy-packaging.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-sa-plan-tls-service-deploy-packaging.md)
...
| field | value |
|---|---|
| id | `sa-plan-tls-service-deploy-packaging` |
| name | sa-plan-tls.service (deploy packaging) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/sa-plan-tls-service-deploy-packaging` |
| uid | `8e7717302f47f` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/sub-projects/c3i/deploy/systemd/sa-plan-tls.service` |
