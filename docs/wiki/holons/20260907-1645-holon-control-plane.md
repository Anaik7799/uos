...
[docs/wiki/holons/20260907-1645-holon-control-plane.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-control-plane.md)
...
| id | `control-plane` |
| name | Control plane |
| Sanskrit | niyantraṇa-tala (नियन्त्रण-तल) |
| kind | plane |
| level | L1 |
| plane | control · niyantraṇa (नियन्त्रण) |
| address | `uos/holon/L1/control/control-plane` |
| uid | `9682666514c07` |
| whole | [planes](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-planes.md) — Seven planes |
| parts | [coord](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-coord.md), [stpa](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-stpa.md), [cepaf-gleam](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-cepaf-gleam.md), [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) |
| module | `uos_tui/coord` |
| lifecycle | dormant |
