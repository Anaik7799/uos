# c3i-pressure-publisher-service — c3i-pressure-publisher.service

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-pressure-publisher-service.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-pressure-publisher-service.md)
...
| field | value |
|---|---|
| id | `c3i-pressure-publisher-service` |
| name | c3i-pressure-publisher.service |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/c3i-pressure-publisher-service` |
| uid | `7a43ed0253a46` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `gleam run -m scripts/sysd/pressure_publish` |
