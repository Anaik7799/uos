# mcp-stdio-servers-zigvm-harness-mcp-hermes-ops-mcp — MCP stdio servers (zigvm_harness --mcp, hermes_ops mcp)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-mcp-stdio-servers-zigvm-harness-mcp-hermes-ops-mcp.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-mcp-stdio-servers-zigvm-harness-mcp-hermes-ops-mcp.md)
...
| field | value |
|---|---|
| id | `mcp-stdio-servers-zigvm-harness-mcp-hermes-ops-mcp` |
| name | MCP stdio servers (zigvm_harness --mcp, hermes_ops mcp) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | messaging · sandeśa (सन्देश) |
| address | `uos/holon/L5/messaging/mcp-stdio-servers-zigvm-harness-mcp-hermes-ops-mcp` |
| uid | `0323049a52f82` |
...
| parts | — (leaf) |
| module | `/home/an/dev/ver/zigvm ... zigvm_harness.exe --mcp; /home/an/NAS-setup/harness-bionic/_build/.../hermes_ops/ops_main.exe mcp` |
| domain | cog |
| process_class | listener |
