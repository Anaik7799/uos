# hermes-tooling-modules-toolchain-nix-vcs-fpp-authority-dune-graph-harness-stubber-fetch-cowboy-sa-plan-test — hermes tooling modules (toolchain/nix/vcs/fpp_authority/dune_graph/harness_stubber/fetch_cowboy/sa_plan test)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-hermes-tooling-modules-toolchain-nix-vcs-fpp-authority-dune-graph-harness-stubber-fetch-cowboy-sa-plan-test.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-hermes-tooling-modules-toolchain-nix-vcs-fpp-authority-dune-graph-harness-stubber-fetch-cowboy-sa-plan-test.md)
...
| field | value |
|---|---|
| id | `hermes-tooling-modules-toolchain-nix-vcs-fpp-authority-dune-graph-harness-stubber-fetch-cowboy-sa-plan-test` |
| name | hermes tooling modules (toolchain/nix/vcs/fpp_authority/dune_graph/harness_stubber/fetch_cowboy/sa_plan test) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/hermes-tooling-modules-toolchain-nix-vcs-fpp-authority-dune-graph-harness-stubber-fetch-cowboy-sa-plan-test` |
| uid | `cd8303ff612e1` |
| whole | [hermes](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-hermes.md) — Hermes OCaml evidence engine |
| parts | — (leaf) |
| module | `engines/hermes/modules/{hermes_toolchain,hermes_nix,hermes_vcs,hermes_fpp_authority,hermes_dune_graph,hermes_harness_stubber,fetch_cowboy}/dune, engines/hermes/modules/sa_plan/test/dune` |
| domain | cog |
