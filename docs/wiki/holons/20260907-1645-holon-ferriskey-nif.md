# ferriskey-nif — ferriskey_nif

#fractal-l0 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-ferriskey-nif.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ferriskey-nif.md)
...
| address | `uos/holon/L0/runtime/ferriskey-nif` |
| uid | `2d588412d03b5` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/ferriskey_nif.erl -> priv/ferriskey_nif.so` |
| domain | iam |
| process_class | nif |
| status | integrated |
| lifecycle | dormant |
