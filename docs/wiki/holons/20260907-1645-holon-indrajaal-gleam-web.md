# indrajaal-gleam-web — Indrajaal Gleam web

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-indrajaal-gleam-web.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-indrajaal-gleam-web.md)
...
| field | value |
|---|---|
| id | `indrajaal-gleam-web` |
| name | Indrajaal Gleam web |
| Sanskrit | jala-yantra (जाल-यन्त्र) |
| kind | subsystem |
| level | L2 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L2/runtime/indrajaal-gleam-web` |
| uid | `94aa5e045803b` |
...
| parts | [c3i-sa-plan-http-service](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-sa-plan-http-service.md), [spec-child-indrajaal-web](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-indrajaal-web.md), [apps-indrajaal-gleam-library](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-apps-indrajaal-gleam-library.md), [indrajaal-gleam-web-mist-http-listener-4100](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-indrajaal-gleam-web-mist-http-listener-4100.md), [indrajaal-web-elixir-phoenix-legacy](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-indrajaal-web-elixir-phoenix-legacy.md) |
| module | `apps/indrajaal_gleam_web` |
| lifecycle | dormant |
