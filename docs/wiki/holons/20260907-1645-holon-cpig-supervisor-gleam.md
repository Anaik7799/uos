# cpig-supervisor-gleam — cpig_supervisor.gleam

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-cpig-supervisor-gleam.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-cpig-supervisor-gleam.md)
...
| field | value |
|---|---|
| id | `cpig-supervisor-gleam` |
| name | cpig_supervisor.gleam |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/cpig-supervisor-gleam` |
| uid | `280cdf74bd133` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/actors/cpig_supervisor.gleam` |
| domain | cpig |
