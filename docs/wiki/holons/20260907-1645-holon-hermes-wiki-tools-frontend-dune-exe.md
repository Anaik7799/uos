# hermes-wiki-tools-frontend-dune-exe — hermes_wiki tools+frontend (dune exe)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-hermes-wiki-tools-frontend-dune-exe.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-hermes-wiki-tools-frontend-dune-exe.md)
...
| field | value |
|---|---|
| id | `hermes-wiki-tools-frontend-dune-exe` |
| name | hermes_wiki tools+frontend (dune exe) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/hermes-wiki-tools-frontend-dune-exe` |
| uid | `8545006db2c32` |
...
| parts | — (leaf) |
| module | `engines/hermes/modules/hermes_wiki/src/{tools,frontend}/dune` |
| domain | cog |
