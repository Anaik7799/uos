# c3i-sa-plan-http-service — c3i-sa-plan-http.service

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-sa-plan-http-service.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-sa-plan-http-service.md)
...
| field | value |
|---|---|
| id | `c3i-sa-plan-http-service` |
| name | c3i-sa-plan-http.service |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/c3i-sa-plan-http-service` |
| uid | `7e59c0a5dfd16` |
...
| parts | — (leaf) |
| module | `sa-plan serve --port 4200` |
