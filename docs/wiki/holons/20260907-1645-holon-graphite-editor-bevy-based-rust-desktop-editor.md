# graphite-editor-bevy-based-rust-desktop-editor — graphite-editor (Bevy-based Rust desktop editor)

#fractal-l1 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-graphite-editor-bevy-based-rust-desktop-editor.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-graphite-editor-bevy-based-rust-desktop-editor.md)
...
| field | value |
|---|---|
| id | `graphite-editor-bevy-based-rust-desktop-editor` |
| name | graphite-editor (Bevy-based Rust desktop editor) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L1 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L1/runtime/graphite-editor-bevy-based-rust-desktop-editor` |
| uid | `486e3cc85cd50` |
...
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/lib/cepaf_gleam/native/graphite-editor/desktop (+ platform/linux, platform/mac, platform/win Cargo.toml)` |
