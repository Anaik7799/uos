# spec-child-hermes-oracle-supervisor — spec-child: hermes_oracle_supervisor

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-spec-child-hermes-oracle-supervisor.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-hermes-oracle-supervisor.md)
...
| field | value |
|---|---|
| id | `spec-child-hermes-oracle-supervisor` |
| name | spec-child: hermes_oracle_supervisor |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L5/runtime/spec-child-hermes-oracle-supervisor` |
| uid | `2b7211c60292f` |
...
| parts | — (leaf) |
| module | `uos_sup.gleam EnginesDomain child (string only)` |
| domain | cog |
