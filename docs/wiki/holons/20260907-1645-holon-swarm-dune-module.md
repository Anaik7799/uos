# swarm-dune-module — swarm (dune module)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-swarm-dune-module.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-swarm-dune-module.md)
...
| field | value |
|---|---|
| id | `swarm-dune-module` |
| name | swarm (dune module) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L5/runtime/swarm-dune-module` |
| uid | `8c7b79b40718e` |
...
| parts | — (leaf) |
| module | `engines/hermes/modules/swarm/dune` |
| domain | cog |
