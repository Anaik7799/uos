# uos — Unified Operational System

#fractal-l0 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-uos.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-uos.md)
...
|---|---|
| id | `uos` |
| name | Unified Operational System |
| Sanskrit | ekīkṛta-kārya-tantra (एकीकृत-कार्य-तन्त्र) |
| kind | system |
| level | L0 |
| plane | control · niyantraṇa (नियन्त्रण) |
| address | `uos/holon/L0/control/uos` |
| uid | `b7f687f9309db` |
| whole | — (root) |
| parts | [supervisor](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-supervisor.md), [planes](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-planes.md), [constitution](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-constitution.md) |
| module | `apps/uos_tui` |
| lifecycle | dormant |
