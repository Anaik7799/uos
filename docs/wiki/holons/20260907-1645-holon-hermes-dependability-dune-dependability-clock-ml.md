# hermes-dependability-dune-dependability-clock-ml — hermes_dependability (dune, dependability_clock.ml)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-hermes-dependability-dune-dependability-clock-ml.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-hermes-dependability-dune-dependability-clock-ml.md)
...
| field | value |
|---|---|
| id | `hermes-dependability-dune-dependability-clock-ml` |
| name | hermes_dependability (dune, dependability_clock.ml) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/hermes-dependability-dune-dependability-clock-ml` |
| uid | `3a084a5d4e70c` |
...
| parts | — (leaf) |
| module | `engines/hermes/modules/hermes_dependability/dune` |
| domain | cog |
