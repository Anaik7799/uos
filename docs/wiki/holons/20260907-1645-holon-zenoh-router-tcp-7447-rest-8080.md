# zenoh-router-tcp-7447-rest-8080 — Zenoh router TCP:7447 / REST:8080

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-zenoh-router-tcp-7447-rest-8080.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-zenoh-router-tcp-7447-rest-8080.md)
...
| field | value |
|---|---|
| id | `zenoh-router-tcp-7447-rest-8080` |
| name | Zenoh router TCP:7447 / REST:8080 |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | messaging · sandeśa (सन्देश) |
| address | `uos/holon/L4/messaging/zenoh-router-tcp-7447-rest-8080` |
| uid | `be0dc0a896c80` |
| whole | [ops](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ops.md) — UOS operational units |
| parts | — (leaf) |
| module | `c3i-zenoh-router-1 podman container (docker.io/eclipse/zenoh); config ops/zenoh/20260907-0450-uos-zenoh-router-1.json5` |
