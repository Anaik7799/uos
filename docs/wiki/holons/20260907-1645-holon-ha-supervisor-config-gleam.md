# ha-supervisor-config-gleam — ha/supervisor_config.gleam

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-ha-supervisor-config-gleam.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ha-supervisor-config-gleam.md)
...
| field | value |
|---|---|
| id | `ha-supervisor-config-gleam` |
| name | ha/supervisor_config.gleam |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/ha-supervisor-config-gleam` |
| uid | `d7d10dcc439a5` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/ha/supervisor_config.gleam` |
