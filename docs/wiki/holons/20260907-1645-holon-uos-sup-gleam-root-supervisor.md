# uos-sup-gleam-root-supervisor — uos_sup.gleam root supervisor

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-uos-sup-gleam-root-supervisor.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-uos-sup-gleam-root-supervisor.md)
...
| field | value |
|---|---|
| id | `uos-sup-gleam-root-supervisor` |
| name | uos_sup.gleam root supervisor |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/uos-sup-gleam-root-supervisor` |
| uid | `0d1ce0a641a03` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/uos_sup.gleam` |
