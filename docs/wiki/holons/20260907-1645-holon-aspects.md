# aspects — 17-aspect audit

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-aspects.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-aspects.md)
...
|---|---|
| id | `aspects` |
| name | 17-aspect audit |
| Sanskrit | saptadaśa-pakṣa (सप्तदश-पक्ष) |
| kind | component |
| level | L2 |
| plane | structure · saṃracanā (संरचना) |
| address | `uos/holon/L2/structure/aspects` |
| uid | `3b6320a6867d2` |
