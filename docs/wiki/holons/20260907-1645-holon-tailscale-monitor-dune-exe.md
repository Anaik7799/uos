# tailscale-monitor-dune-exe — tailscale_monitor (dune exe)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-tailscale-monitor-dune-exe.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tailscale-monitor-dune-exe.md)
...
| field | value |
|---|---|
| id | `tailscale-monitor-dune-exe` |
| name | tailscale_monitor (dune exe) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/tailscale-monitor-dune-exe` |
| uid | `2101ad21196c9` |
...
| parts | — (leaf) |
| module | `engines/hermes/modules/tailscale_monitor/dune` |
| domain | cog |
