# tools-sa-plan-ocaml-sa-plan-main-exe — tools/sa-plan (OCaml sa_plan_main.exe)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-tools-sa-plan-ocaml-sa-plan-main-exe.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools-sa-plan-ocaml-sa-plan-main-exe.md)
...
| field | value |
|---|---|
| id | `tools-sa-plan-ocaml-sa-plan-main-exe` |
| name | tools/sa-plan (OCaml sa_plan_main.exe) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/tools-sa-plan-ocaml-sa-plan-main-exe` |
| uid | `786ac2b663309` |
...
| parts | — (leaf) |
| module | `tools/sa-plan (bash wrapper) -> engines/hermes/_build/default/modules/sa_plan/test/sa_plan_main.exe; live DB at var/sa-plan/uos.sqlite3` |
| domain | cog |
