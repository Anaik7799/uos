# k8s-lab-rust-cli-render-kube-apply-spec — k8s-lab Rust CLI (render/kube_apply/spec)

#fractal-l6 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-k8s-lab-rust-cli-render-kube-apply-spec.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-k8s-lab-rust-cli-render-kube-apply-spec.md)
...
| field | value |
|---|---|
| id | `k8s-lab-rust-cli-render-kube-apply-spec` |
| name | k8s-lab Rust CLI (render/kube_apply/spec) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L6 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L6/runtime/k8s-lab-rust-cli-render-kube-apply-spec` |
| uid | `6e65f45480058` |
| whole | [ops](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ops.md) — UOS operational units |
| parts | — (leaf) |
| module | `/home/an/NAS-setup/k8s-lab/src/{main.rs,spec.rs,render.rs,kube_apply.rs}` |
