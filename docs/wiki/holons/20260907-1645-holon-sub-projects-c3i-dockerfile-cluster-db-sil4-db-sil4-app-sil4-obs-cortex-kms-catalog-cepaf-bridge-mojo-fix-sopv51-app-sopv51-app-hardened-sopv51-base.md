# sub-projects-c3i-dockerfile-cluster-db-sil4-db-sil4-app-sil4-obs-cortex-kms-catalog-cepaf-bridge-mojo-fix-sopv51-app-sopv51-app-hardened-sopv51-base — sub-projects/c3i Dockerfile.* cluster (db, sil4-db, sil4-app, sil4-obs, cortex, kms-catalog, cepaf-bridge, mojo, fix, sopv51-app, sopv51-app-hardened, sopv51-base)

#fractal-l6 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-sub-projects-c3i-dockerfile-cluster-db-sil4-db-sil4-app-sil4-obs-cortex-kms-catalog-cepaf-bridge-mojo-fix-sopv51-app-sopv51-app-hardened-sopv51-base.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-sub-projects-c3i-dockerfile-cluster-db-sil4-db-sil4-app-sil4-obs-cortex-kms-catalog-cepaf-bridge-mojo-fix-sopv51-app-sopv51-app-hardened-sopv51-base.md)
...
| field | value |
|---|---|
| id | `sub-projects-c3i-dockerfile-cluster-db-sil4-db-sil4-app-sil4-obs-cortex-kms-catalog-cepaf-bridge-mojo-fix-sopv51-app-sopv51-app-hardened-sopv51-base` |
| name | sub-projects/c3i Dockerfile.* cluster (db, sil4-db, sil4-app, sil4-obs, cortex, kms-catalog, cepaf-bridge, mojo, fix, sopv51-app, sopv51-app-hardened, sopv51-base) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L6 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L6/runtime/sub-projects-c3i-dockerfile-cluster-db-sil4-db-sil4-app-sil4-obs-cortex-kms-catalog-cepaf-bridge-mojo-fix-sopv51-app-sopv51-app-hardened-sopv51-base` |
| uid | `c812aa2067921` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/sub-projects/c3i/Dockerfile.* (12 files)` |
| process_class | container |
| status | absent |
| lifecycle | dormant |
