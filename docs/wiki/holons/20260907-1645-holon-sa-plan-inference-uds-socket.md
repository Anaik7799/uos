# sa-plan-inference-uds-socket — sa-plan inference UDS socket

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-sa-plan-inference-uds-socket.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-sa-plan-inference-uds-socket.md)
...
| field | value |
|---|---|
| id | `sa-plan-inference-uds-socket` |
| name | sa-plan inference UDS socket |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | messaging · sandeśa (सन्देश) |
| address | `uos/holon/L5/messaging/sa-plan-inference-uds-socket` |
| uid | `99266e8530c89` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `c3i-sa-plan-inference.service, %t/c3i/inference.sock` |
| domain | cog |
