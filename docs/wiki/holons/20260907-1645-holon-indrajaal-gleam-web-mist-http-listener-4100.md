# indrajaal-gleam-web-mist-http-listener-4100 — indrajaal_gleam_web Mist HTTP listener :4100

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-indrajaal-gleam-web-mist-http-listener-4100.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-indrajaal-gleam-web-mist-http-listener-4100.md)
...
| field | value |
|---|---|
| id | `indrajaal-gleam-web-mist-http-listener-4100` |
| name | indrajaal_gleam_web Mist HTTP listener :4100 |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | messaging · sandeśa (सन्देश) |
| address | `uos/holon/L4/messaging/indrajaal-gleam-web-mist-http-listener-4100` |
| uid | `8898df55abc66` |
...
| parts | — (leaf) |
| module | `apps/indrajaal_gleam_web/src/indrajaal_gleam_web.gleam:988-990 (mist.new/port/bind)` |
