# c3i-gleam-server-service — c3i-gleam-server.service

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-gleam-server-service.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-gleam-server-service.md)
...
| field | value |
|---|---|
| id | `c3i-gleam-server-service` |
| name | c3i-gleam-server.service |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/c3i-gleam-server-service` |
| uid | `7a5122cc5ae42` |
...
| parts | — (leaf) |
| module | `/home/an/NAS-setup/c3i/sa-gleam-start` |
