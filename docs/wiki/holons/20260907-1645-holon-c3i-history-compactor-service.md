# c3i-history-compactor-service — c3i-history-compactor.service

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-history-compactor-service.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-history-compactor-service.md)
...
| field | value |
|---|---|
| id | `c3i-history-compactor-service` |
| name | c3i-history-compactor.service |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/c3i-history-compactor-service` |
| uid | `4d92f29c0b6f1` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `gleam run -m scripts/pass10/p10_history_compactor` |
