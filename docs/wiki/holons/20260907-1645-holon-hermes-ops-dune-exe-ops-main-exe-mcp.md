# hermes-ops-dune-exe-ops-main-exe-mcp — hermes_ops (dune exe, ops_main.exe mcp)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-hermes-ops-dune-exe-ops-main-exe-mcp.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-hermes-ops-dune-exe-ops-main-exe-mcp.md)
...
| field | value |
|---|---|
| id | `hermes-ops-dune-exe-ops-main-exe-mcp` |
| name | hermes_ops (dune exe, ops_main.exe mcp) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/hermes-ops-dune-exe-ops-main-exe-mcp` |
| uid | `ff0049d206314` |
...
| parts | — (leaf) |
| module | `engines/hermes/modules/hermes_ops/dune` |
| domain | cog |
