# heartbeats — Freshness monitor

#fractal-l3 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-heartbeats.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-heartbeats.md)
...
| Sanskrit | spandana (स्पन्दन) |
| kind | component |
| level | L3 |
| plane | control · niyantraṇa (नियन्त्रण) |
| address | `uos/holon/L3/control/heartbeats` |
| uid | `e8d3d6e5863b4` |
| whole | [coord](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-coord.md) — Coordination & sync |
| parts | — (leaf) |
| module | `uos_tui/coord (beat/stale)` |
| lifecycle | dormant |
