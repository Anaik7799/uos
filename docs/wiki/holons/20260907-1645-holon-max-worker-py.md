# max-worker-py — max_worker.py

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-max-worker-py.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-max-worker-py.md)
...
| address | `uos/holon/L5/runtime/max-worker-py` |
| uid | `2c78c9967707b` |
...
| parts | — (leaf) |
| module | `services/inference/max/max_worker.py` |
| domain | cog |
