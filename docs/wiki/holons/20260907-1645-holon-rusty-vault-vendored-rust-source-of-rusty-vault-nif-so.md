# rusty-vault-vendored-rust-source-of-rusty-vault-nif-so — rusty_vault_vendored (Rust, source of rusty_vault_nif.so)

#fractal-l0 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-rusty-vault-vendored-rust-source-of-rusty-vault-nif-so.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-rusty-vault-vendored-rust-source-of-rusty-vault-nif-so.md)
...
| field | value |
|---|---|
| id | `rusty-vault-vendored-rust-source-of-rusty-vault-nif-so` |
| name | rusty_vault_vendored (Rust, source of rusty_vault_nif.so) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L0 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L0/runtime/rusty-vault-vendored-rust-source-of-rusty-vault-nif-so` |
| uid | `c0fa54dedd29c` |
| whole | [constitution](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-constitution.md) — L0 constitutional whole: IAM, secrets, clock guard, governance |
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/sub-projects/rusty_vault_vendored` |
| domain | secret |
