# mcp-c3i-server-rust — mcp/c3i_server (Rust)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-mcp-c3i-server-rust.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-mcp-c3i-server-rust.md)
