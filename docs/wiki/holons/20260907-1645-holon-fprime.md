# fprime — F´ dictionaries

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-fprime.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-fprime.md)
...
| id | `fprime` |
| name | F´ dictionaries |
| Sanskrit | śabda-kośa (शब्द-कोश) |
| kind | component |
| level | L2 |
| plane | structure · saṃracanā (संरचना) |
| address | `uos/holon/L2/structure/fprime` |
| uid | `fcad047b7c7c8` |
