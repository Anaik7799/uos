# c3i-sa-plan-default-scheduler-service — c3i-sa-plan-default-scheduler.service

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-sa-plan-default-scheduler-service.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-sa-plan-default-scheduler-service.md)
...
| field | value |
|---|---|
| id | `c3i-sa-plan-default-scheduler-service` |
| name | c3i-sa-plan-default-scheduler.service |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/c3i-sa-plan-default-scheduler-service` |
| uid | `1d38c030a7f5b` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `sa-plan scheduler-run --queue default --limit 8 --interval 2` |
