# max-kernel-mojo — max_kernel.mojo

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-max-kernel-mojo.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-max-kernel-mojo.md)
...
|---|---|
| id | `max-kernel-mojo` |
| name | max_kernel.mojo |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/max-kernel-mojo` |
| uid | `ca8508522f49e` |
...
| parts | — (leaf) |
| module | `services/inference/max/max_kernel.mojo` |
| domain | cog |
