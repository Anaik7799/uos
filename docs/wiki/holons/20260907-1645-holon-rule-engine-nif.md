# rule-engine-nif — rule_engine_nif

#fractal-l1 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-rule-engine-nif.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-rule-engine-nif.md)
...
|---|---|
| id | `rule-engine-nif` |
| name | rule_engine_nif |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L1 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L1/runtime/rule-engine-nif` |
| uid | `5f1c2ab48c607` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/rule_engine_nif.erl -> priv/rule_engine_nif.so` |
| process_class | nif |
| status | integrated |
| lifecycle | dormant |
