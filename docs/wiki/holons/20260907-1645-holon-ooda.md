# ooda — Fast OODA controller

#fractal-l3 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-ooda.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ooda.md)
...
|---|---|
| id | `ooda` |
| name | Fast OODA controller |
| Sanskrit | cakra (चक्र) |
| kind | component |
| level | L3 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L3/intelligence/ooda` |
| uid | `df367892ecd37` |
| whole | [manager](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-manager.md) — F´ managing agent |
| parts | — (leaf) |
| module | `uos_tui/ooda` |
| lifecycle | dormant |
