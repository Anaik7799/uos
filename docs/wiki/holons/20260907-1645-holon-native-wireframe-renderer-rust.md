# native-wireframe-renderer-rust — native/wireframe_renderer (Rust)

#fractal-l1 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-native-wireframe-renderer-rust.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-native-wireframe-renderer-rust.md)
...
| field | value |
|---|---|
| id | `native-wireframe-renderer-rust` |
| name | native/wireframe_renderer (Rust) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L1 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L1/runtime/native-wireframe-renderer-rust` |
| uid | `084d8c57d803f` |
...
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/sub-projects/c3i/native/wireframe_renderer` |
