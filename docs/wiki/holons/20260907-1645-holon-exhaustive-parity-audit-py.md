# exhaustive-parity-audit-py — exhaustive_parity_audit.py

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-exhaustive-parity-audit-py.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-exhaustive-parity-audit-py.md)
...
| field | value |
|---|---|
| id | `exhaustive-parity-audit-py` |
| name | exhaustive_parity_audit.py |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/exhaustive-parity-audit-py` |
| uid | `d7a4149770dd4` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/scripts/exhaustive_parity_audit.py` |
| domain | unassigned |
