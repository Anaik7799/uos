# c3i-sa-plan-inference-service — c3i-sa-plan-inference.service

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-sa-plan-inference-service.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-sa-plan-inference-service.md)
...
| field | value |
|---|---|
| id | `c3i-sa-plan-inference-service` |
| name | c3i-sa-plan-inference.service |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L5/runtime/c3i-sa-plan-inference-service` |
| uid | `3a2185d86fa12` |
| whole | [inference-max](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-inference-max.md) — Modular MAX inference tier |
| parts | — (leaf) |
| module | `sa-plan inference-serve --sock %t/c3i/inference.sock` |
| domain | cog |
