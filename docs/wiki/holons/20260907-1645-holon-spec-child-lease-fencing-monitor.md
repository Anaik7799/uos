# spec-child-lease-fencing-monitor — spec-child: lease_fencing_monitor

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-spec-child-lease-fencing-monitor.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-lease-fencing-monitor.md)
...
| field | value |
|---|---|
| id | `spec-child-lease-fencing-monitor` |
| name | spec-child: lease_fencing_monitor |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/spec-child-lease-fencing-monitor` |
| uid | `8114873a73c31` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `uos_sup.gleam IntelligenceDomain child (string only)` |
