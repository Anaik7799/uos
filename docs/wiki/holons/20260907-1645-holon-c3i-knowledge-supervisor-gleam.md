# c3i-knowledge-supervisor-gleam — c3i_knowledge_supervisor.gleam

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-knowledge-supervisor-gleam.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-knowledge-supervisor-gleam.md)
...
| field | value |
|---|---|
| id | `c3i-knowledge-supervisor-gleam` |
| name | c3i_knowledge_supervisor.gleam |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/c3i-knowledge-supervisor-gleam` |
| uid | `f100c11e94a8d` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/knowledge/c3i_knowledge_supervisor.gleam` |
