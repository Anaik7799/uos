# ferriskey-vendored-containers-k8s-manifests — ferriskey-vendored containers + k8s manifests

#fractal-l6 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-ferriskey-vendored-containers-k8s-manifests.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ferriskey-vendored-containers-k8s-manifests.md)
...
| field | value |
|---|---|
| id | `ferriskey-vendored-containers-k8s-manifests` |
| name | ferriskey-vendored containers + k8s manifests |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L6 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L6/runtime/ferriskey-vendored-containers-k8s-manifests` |
| uid | `cfdb28532cdac` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/sub-projects/ferriskey-vendored/{Dockerfile, charts/ferriskey/templates/{api,webapp}/deployment.yaml, charts/ferriskey/templates/postgresql/statefulset.yaml, operator/k8s/deployment.yaml}` |
| process_class | container |
| status | imported-not-wired |
| lifecycle | dormant |
