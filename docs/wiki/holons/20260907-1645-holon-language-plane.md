# language-plane — Language plane

#fractal-l1 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-language-plane.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-language-plane.md)
...
| id | `language-plane` |
| name | Language plane |
| Sanskrit | bhāṣā-tala (भाषा-तल) |
| kind | plane |
| level | L1 |
| plane | language · bhāṣā (भाषा) |
| address | `uos/holon/L1/language/language-plane` |
| uid | `81c87b499a3d4` |
| whole | [planes](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-planes.md) — Seven planes |
| parts | [acl](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-acl.md) |
| module | `uos_tui/acl` |
| lifecycle | dormant |
