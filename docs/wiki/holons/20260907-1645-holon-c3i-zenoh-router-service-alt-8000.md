# c3i-zenoh-router-service-alt-8000 — c3i-zenoh-router.service (alt/:8000)

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-zenoh-router-service-alt-8000.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-zenoh-router-service-alt-8000.md)
...
| field | value |
|---|---|
| id | `c3i-zenoh-router-service-alt-8000` |
| name | c3i-zenoh-router.service (alt/:8000) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/c3i-zenoh-router-service-alt-8000` |
| uid | `38067e5dffee6` |
| whole | [ops](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ops.md) — UOS operational units |
| parts | — (leaf) |
| module | `~/.config/systemd/user/c3i-zenoh-router.service; podman run ... --rest-http-port 8000` |
