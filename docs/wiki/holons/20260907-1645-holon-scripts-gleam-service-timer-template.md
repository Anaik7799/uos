# scripts-gleam-service-timer-template — scripts-gleam@.service / .timer (template)

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-scripts-gleam-service-timer-template.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-scripts-gleam-service-timer-template.md)
...
| field | value |
|---|---|
| id | `scripts-gleam-service-timer-template` |
| name | scripts-gleam@.service / .timer (template) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/scripts-gleam-service-timer-template` |
| uid | `acf33322d6acc` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/sub-projects/scripts-gleam/deploy/systemd/scripts-gleam@.{service,timer}` |
