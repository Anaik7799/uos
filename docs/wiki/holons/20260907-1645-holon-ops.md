# ops — UOS operational units

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-ops.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ops.md)
...
|---|---|
| id | `ops` |
| name | UOS operational units |
| Sanskrit | karma-tantra (कर्म-तन्त्र) |
| kind | subsystem |
| level | L2 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L2/runtime/ops` |
| uid | `a92c36e66a25e` |
...
| parts | [c3i-target](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-target.md), [c3i-zenoh-router-service-alt-8000](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-zenoh-router-service-alt-8000.md), [c3i-zenoh-router-1-service](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-zenoh-router-1-service.md), [zenoh-router-tcp-7447-rest-8080](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-zenoh-router-tcp-7447-rest-8080.md), [k8s-lab-rust-cli-render-kube-apply-spec](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-k8s-lab-rust-cli-render-kube-apply-spec.md) |
| module | `ops` |
| lifecycle | dormant |
