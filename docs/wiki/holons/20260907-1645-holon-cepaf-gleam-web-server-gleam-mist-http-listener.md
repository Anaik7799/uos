# cepaf-gleam-web-server-gleam-mist-http-listener — cepaf_gleam web/server.gleam Mist HTTP listener

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-cepaf-gleam-web-server-gleam-mist-http-listener.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-cepaf-gleam-web-server-gleam-mist-http-listener.md)
...
| field | value |
|---|---|
| id | `cepaf-gleam-web-server-gleam-mist-http-listener` |
| name | cepaf_gleam web/server.gleam Mist HTTP listener |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | messaging · sandeśa (सन्देश) |
| address | `uos/holon/L4/messaging/cepaf-gleam-web-server-gleam-mist-http-listener` |
| uid | `0959c7c49088f` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam/web/server.gleam:1228-1230` |
