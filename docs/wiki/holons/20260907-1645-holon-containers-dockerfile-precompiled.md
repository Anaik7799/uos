# containers-dockerfile-precompiled — containers/Dockerfile.precompiled

#fractal-l6 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-containers-dockerfile-precompiled.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-containers-dockerfile-precompiled.md)
...
| field | value |
|---|---|
| id | `containers-dockerfile-precompiled` |
| name | containers/Dockerfile.precompiled |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L6 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L6/runtime/containers-dockerfile-precompiled` |
| uid | `dcf5f4b75d3c4` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `/home/an/dev/ver/c3i/containers/Dockerfile.precompiled (also under sub-projects/c3i/containers/)` |
