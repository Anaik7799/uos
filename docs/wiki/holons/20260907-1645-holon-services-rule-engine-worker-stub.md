# services-rule-engine-worker-stub — services/rule_engine_worker (stub)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-services-rule-engine-worker-stub.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-services-rule-engine-worker-stub.md)
...
| field | value |
|---|---|
| id | `services-rule-engine-worker-stub` |
| name | services/rule_engine_worker (stub) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L5/runtime/services-rule-engine-worker-stub` |
| uid | `34700a4229a1e` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `services/rule_engine_worker/README.md` |
| domain | cog |
