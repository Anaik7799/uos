# zigvm — ZigVM deterministic runtime

#fractal-l1 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-zigvm.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-zigvm.md)
...
|---|---|
| id | `zigvm` |
| name | ZigVM deterministic runtime |
| Sanskrit | niyata-yantra (नियत-यन्त्र) |
| kind | subsystem |
| level | L1 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L1/runtime/zigvm` |
| uid | `698423f888d83` |
...
| parts | [spec-child-zigvm-port-manager](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-zigvm-port-manager.md), [indrajaal-ark-zig-zig](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-indrajaal-ark-zig-zig.md) |
| module | `engines/zigvm` |
| lifecycle | dormant |
