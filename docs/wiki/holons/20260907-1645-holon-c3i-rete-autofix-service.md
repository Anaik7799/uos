# c3i-rete-autofix-service — c3i-rete-autofix.service

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-rete-autofix-service.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-rete-autofix-service.md)
...
| field | value |
|---|---|
| id | `c3i-rete-autofix-service` |
| name | c3i-rete-autofix.service |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L5/runtime/c3i-rete-autofix-service` |
| uid | `517c6ca53f521` |
...
| parts | — (leaf) |
| module | `gleam run -m scripts/pass10/p10_rete_autofix` |
| domain | cog |
