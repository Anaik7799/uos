# graphene-nif-loader — graphene_nif (loader)

#fractal-l1 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-graphene-nif-loader.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-graphene-nif-loader.md)
...
| field | value |
|---|---|
| id | `graphene-nif-loader` |
| name | graphene_nif (loader) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L1 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L1/runtime/graphene-nif-loader` |
| uid | `92b7258733f7c` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/graphene_nif.erl` |
| process_class | nif |
| status | superseded |
| lifecycle | apoptotic |
