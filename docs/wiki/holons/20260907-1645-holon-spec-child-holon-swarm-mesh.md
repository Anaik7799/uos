# spec-child-holon-swarm-mesh — spec-child: holon_swarm_mesh

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-spec-child-holon-swarm-mesh.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-holon-swarm-mesh.md)
...
| field | value |
|---|---|
| id | `spec-child-holon-swarm-mesh` |
| name | spec-child: holon_swarm_mesh |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/spec-child-holon-swarm-mesh` |
| uid | `21d364898f514` |
| whole | [uos-tui](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-uos-tui.md) — UOS TUI cockpit |
| parts | — (leaf) |
