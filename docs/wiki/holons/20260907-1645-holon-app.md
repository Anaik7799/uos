# app — TEA application core

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-app.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-app.md)
...
|---|---|
| id | `app` |
| name | TEA application core |
| Sanskrit | mūla-yantra (मूल-यन्त्र) |
| kind | component |
| level | L2 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L2/runtime/app` |
| uid | `a172cedcae474` |
...
| parts | [widgets](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-widgets.md), [render](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-render.md) |
| module | `uos_tui/app` |
| lifecycle | dormant |
