# uos-swarm — UOS swarm package

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-uos-swarm.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-uos-swarm.md)
...
|---|---|
| id | `uos-swarm` |
| name | UOS swarm package |
| Sanskrit | jhunda (झुण्ड) |
| kind | subsystem |
| level | L2 |
| plane | messaging · sandeśa (सन्देश) |
| address | `uos/holon/L2/messaging/uos-swarm` |
| uid | `bf3646e876539` |
| whole | [messaging-plane](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-messaging-plane.md) — Messaging plane |
| parts | [spec-child-max-isolated-worker](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-max-isolated-worker.md), [max-worker-py](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-max-worker-py.md), [swarm-dune-module](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-swarm-dune-module.md) |
| module | `apps/uos_swarm` |
| lifecycle | dormant |
