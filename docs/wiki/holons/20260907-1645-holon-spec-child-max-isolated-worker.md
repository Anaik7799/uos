# spec-child-max-isolated-worker — spec-child: max_isolated_worker

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-spec-child-max-isolated-worker.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-max-isolated-worker.md)
...
| field | value |
|---|---|
| id | `spec-child-max-isolated-worker` |
| name | spec-child: max_isolated_worker |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/spec-child-max-isolated-worker` |
| uid | `42cb2d367e6bf` |
| whole | [uos-swarm](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-uos-swarm.md) — UOS swarm package |
| parts | — (leaf) |
| module | `uos_sup.gleam ServicesDomain child (string only)` |
