# spec-child-indrajaal-web — spec-child: indrajaal_web

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-spec-child-indrajaal-web.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-indrajaal-web.md)
...
| field | value |
|---|---|
| id | `spec-child-indrajaal-web` |
| name | spec-child: indrajaal_web |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/spec-child-indrajaal-web` |
| uid | `97b614547e413` |
