# rusty-vault-nif — rusty_vault_nif

#fractal-l0 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-rusty-vault-nif.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-rusty-vault-nif.md)
...
| address | `uos/holon/L0/runtime/rusty-vault-nif` |
| uid | `e2b1a4780bf7e` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/rusty_vault_nif.erl -> priv/rusty_vault_nif.so` |
| domain | secret |
| process_class | nif |
| status | integrated |
| lifecycle | dormant |
