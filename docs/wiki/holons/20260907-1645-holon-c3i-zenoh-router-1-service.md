# c3i-zenoh-router-1-service — c3i-zenoh-router-1.service

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-zenoh-router-1-service.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-zenoh-router-1-service.md)
...
| field | value |
|---|---|
| id | `c3i-zenoh-router-1-service` |
| name | c3i-zenoh-router-1.service |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/c3i-zenoh-router-1-service` |
| uid | `1c65e9989f90e` |
| whole | [ops](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-ops.md) — UOS operational units |
| parts | — (leaf) |
| module | `~/.config/systemd/user/c3i-zenoh-router-1.service; podman start c3i-zenoh-router-1 (docker.io/eclipse/zenoh)` |
