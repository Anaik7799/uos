# uos-tui — UOS TUI cockpit

#fractal-l2 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-uos-tui.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-uos-tui.md)
...
|---|---|
| id | `uos-tui` |
| name | UOS TUI cockpit |
| Sanskrit | calaka-patala (चालक-पटल) |
| kind | subsystem |
| level | L2 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L2/runtime/uos-tui` |
| uid | `693ee120650a8` |
...
| parts | [spec-child-holon-swarm-mesh](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-holon-swarm-mesh.md), [run-tui-py](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-run-tui-py.md) |
| module | `apps/uos_tui` |
| lifecycle | dormant |
