# spec-child-indrajaal-holon-runtime — spec-child: indrajaal_holon_runtime

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-spec-child-indrajaal-holon-runtime.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-spec-child-indrajaal-holon-runtime.md)
...
| field | value |
|---|---|
| id | `spec-child-indrajaal-holon-runtime` |
| name | spec-child: indrajaal_holon_runtime |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/spec-child-indrajaal-holon-runtime` |
| uid | `3f87942ff01c5` |
| whole | [tools](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-tools.md) — UOS CLI tooling |
| parts | — (leaf) |
| module | `uos_sup.gleam AppsDomain child (string only)` |
