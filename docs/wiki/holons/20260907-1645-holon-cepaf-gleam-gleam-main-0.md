# cepaf-gleam-gleam-main-0 — cepaf_gleam.gleam main/0

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-cepaf-gleam-gleam-main-0.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-cepaf-gleam-gleam-main-0.md)
...
| field | value |
|---|---|
| id | `cepaf-gleam-gleam-main-0` |
| name | cepaf_gleam.gleam main/0 |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/cepaf-gleam-gleam-main-0` |
| uid | `68adffc6d8f9a` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/cepaf_gleam.gleam` |
| domain | otel |
