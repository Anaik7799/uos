...
[docs/wiki/holons/20260907-1645-holon-c3i-nif.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-nif.md)
...
| address | `uos/holon/L1/runtime/c3i-nif` |
| uid | `72e070b695c52` |
...
| parts | — (leaf) |
| module | `apps/cepaf_gleam/src/c3i_nif.erl -> priv/c3i_nif.so` |
| process_class | nif |
| status | integrated |
| lifecycle | dormant |
