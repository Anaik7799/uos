# apps-indrajaal-gleam-library — apps/indrajaal_gleam (library)

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-apps-indrajaal-gleam-library.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-apps-indrajaal-gleam-library.md)
...
| field | value |
|---|---|
| id | `apps-indrajaal-gleam-library` |
| name | apps/indrajaal_gleam (library) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/apps-indrajaal-gleam-library` |
| uid | `1784f97d8f878` |
...
| parts | — (leaf) |
| module | `apps/indrajaal_gleam/{gleam.toml,manifest.toml,README.md}` |
