# c3i-tls-proxy-service — c3i-tls-proxy.service

#fractal-l4 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-c3i-tls-proxy-service.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-c3i-tls-proxy-service.md)
...
| field | value |
|---|---|
| id | `c3i-tls-proxy-service` |
| name | c3i-tls-proxy.service |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L4 |
| plane | runtime · pravartana (प्रवर्तन) |
| address | `uos/holon/L4/runtime/c3i-tls-proxy-service` |
| uid | `c3a17898cfafa` |
...
| parts | — (leaf) |
| module | `sa-plan tls serve --https-port 8443 --http-port 8088` |
