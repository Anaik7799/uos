# hermes-harness-incl-hermes-rete-ml-compiled-zenoh-c-stub — hermes_harness (incl. hermes_rete.ml + compiled Zenoh C-stub)

#fractal-l5 #km-triad #rocha-semiotics #cybernetics #zero-muda #zk-adr

[docs/wiki/holons/20260907-1645-holon-hermes-harness-incl-hermes-rete-ml-compiled-zenoh-c-stub.md](http://nas-1.tail55d152.ts.net:4100/files/docs/wiki/holons/20260907-1645-holon-hermes-harness-incl-hermes-rete-ml-compiled-zenoh-c-stub.md)
...
| field | value |
|---|---|
| id | `hermes-harness-incl-hermes-rete-ml-compiled-zenoh-c-stub` |
| name | hermes_harness (incl. hermes_rete.ml + compiled Zenoh C-stub) |
| Sanskrit | prakriya (प्रक्रिया) |
| kind | process |
| level | L5 |
| plane | intelligence · buddhi (बुद्धि) |
| address | `uos/holon/L5/intelligence/hermes-harness-incl-hermes-rete-ml-compiled-zenoh-c-stub` |
| uid | `54aae8c472621` |
...
| parts | — (leaf) |
| module | `engines/hermes/modules/hermes_harness/{hermes_rete.ml,.mli,.gospel, dune}; compiled dllhermes_harness_hermes_zenoh_stubs.so` |
| domain | cog |
