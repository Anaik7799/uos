...
- ADR Directory (100 records, `ADR-001`..`ADR-100`, enumerated from `docs/zk/` on 2026-09-09).
  ...
  - `[[zk:20260916-1950-adr-134-zero-copy-rdma-offload-and-heijunka-burst-benchmarks]]` [ADR-134](http://nas-1.tail55d152.ts.net:4100/docs/zk/20260916-1950-adr-134-zero-copy-rdma-offload-and-heijunka-burst-benchmarks.md) Zero-Copy RDMA Offload Architecture and Heijunka High-Burst Benchmarks
  - `[[zk:20260916-2100-adr-135-sciviz-167-extensions-complete-deep-dive-implementation]]` [ADR-135](http://nas-1.tail55d152.ts.net:4100/docs/zk/20260916-2100-adr-135-sciviz-167-extensions-complete-deep-dive-implementation.md) SciViz 167 Extensions Complete Deep-Dive Implementation, Rich Category Geometric Generators, and Headless Browser Media Verification Suite
  - `[[zk:20260917-2030-adr-136-sciviz-167-interactive-filtering-and-browser-verification]]` [ADR-136](http://nas-1.tail55d152.ts.net:4100/docs/zk/20260917-2030-adr-136-sciviz-167-interactive-filtering-and-browser-verification.md) SciViz 167 Interactive Filtering, Real-Time Substring Search, 52 Bespoke Flagship Profiles, and Multi-Interaction Browser Media Verification Suite
  - `[[zk:20260917-2100-adr-137-sciviz-167-complete-bespoke-profiles-and-advanced-explorer]]` [ADR-137](http://nas-1.tail55d152.ts.net:4100/docs/zk/20260917-2100-adr-137-sciviz-167-complete-bespoke-profiles-and-advanced-explorer.md) SciViz All 167 Extensions 100% Bespoke Coverage, Dual View Mode Toggle, Multi-Field Sorting, and Autonomous Browser Verification Suite
- Formal Proofs:
