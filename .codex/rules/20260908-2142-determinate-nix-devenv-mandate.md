...
- **Tailscale FQDN Link**: [http://nas-1.tail55d152.ts.net:4100/files/.codex/rules/DETERMINATE_NIX_RULE](http://nas-1.tail55d152.ts.net:4100/files/.claude/rules/DETERMINATE_NIX_RULE)
