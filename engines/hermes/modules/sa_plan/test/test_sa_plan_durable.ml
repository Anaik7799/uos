...
let () =
  ...
  require "LAW CP05-CANONICAL-V3-UPGRADE-TO-V5"
    (Store.schema_version upgraded = 5
  ...
  require "LAW CP05-V5-REOPEN-DOES-NOT-REGRESS" (Store.schema_version reopened_v3 = 5);
