...
////   (none)                      live cockpit (raw mode, alt screen, q quits)
////   snapshot                    one 120x40 cockpit frame as text
...
import uos_tui/holon
import uos_tui/html
import uos_tui/live
import uos_tui/manager
import uos_tui/ontology
import uos_tui/ooda
import uos_tui/render
import uos_tui/stpa
import uos_tui/swarm
import uos_tui/system_audit
import uos_tui/tps
...
pub fn main() -> Nil {
  ...
  case argv.load().arguments {
    ...
    ["controls", zenoh_base] -> {
      ...
      let cs = agent_runtime.controls("/home/an/NAS-setup/uos", ok)
...
fn state_entries(
  ...
  [
    ...
    #("features", features.to_json(features.sheet())),
    #(
      "fprime_dictionary",
