...
@external(erlang, "uos_tui_ffi", "file_write")
pub fn file_write(path: String, content: String) -> Result(Nil, String)

@external(erlang, "uos_tui_ffi", "sha256_hex")
pub fn sha256_hex(data: String) -> String

@external(erlang, "uos_tui_ffi", "hmac_hex")
pub fn hmac_hex(key: String, data: String) -> String

@external(erlang, "uos_tui_ffi", "board_key")
pub fn board_key() -> Result(String, Nil)

@external(erlang, "uos_tui_ffi", "system_time_us")
