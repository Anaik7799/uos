...
pub fn generate_conversational_response(
  ...
  let system_prompt =
    ...
    <> "  DIRECTIVE: /tool query_fmea_report\n"
    <> "  DIRECTIVE: /tool query_ha_status\n"
    <> "  DIRECTIVE: /tool query_inference_tier\n"
    <> "  DIRECTIVE: /tool query_voice_status\n"
    <> "  DIRECTIVE: /tool query_ooda_phase\n"
    <> "  DIRECTIVE: /tool query_ruliology\n"
    <> "  DIRECTIVE: /tool query_traces_recent\n"
    <> "  DIRECTIVE: /tool query_whatif\n"
    <> "  DIRECTIVE: /tool query_finops\n"
    <> "  DIRECTIVE: /tool query_doctor\n"
    <> "  DIRECTIVE: /tool query_checklist\n"
    <> "- Provide your high-level natural language analysis, and the UOS harness will automatically intercept the DIRECTIVE lines, execute them against live backend services, and attach the real-time operational results to the response.\n"
